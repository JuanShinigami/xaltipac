...
public class EmailService {
    ...
    public void sendSimpleMail(
            ...
            final Locale locale,
            HttpServletRequest req, HttpServletResponse resp,ServletContext serv*/
        ...
        //WebContext ctx = new WebContext(req, resp, serv, req.getLocale());
        ctx.setVariable("name", nameUser);
        ctx.setVariable("username", userNameDetail);
        ...
        message.setText("Datos:"+password);
